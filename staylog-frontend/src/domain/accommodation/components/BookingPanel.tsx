    ...
    <Card className="bg-white">
            ...
            {openCalendar && (
              ...
              >
                ...
                <div className="text-end mt-2">
                  <Button size="sm" variant="primary" onClick={() => setOpenCalendar(false)}>확인</Button>
                </div>
              </div>
            )}
            ...
            {openGuest && (
              <div className="position-absolute bg-white border rounded p-3 shadow-lg mt-1"
                ...
                <div className="text-end mt-3">
                  <Button size="sm" variant="primary" onClick={() => setOpenGuest(false)}>확인</Button>
                </div>
              </div>
            )}
          </div>
      ...
      <Card.Body className="p-4">
        ...
        {selectedRoom ? (
          <div className="mb-4 d-flex align-items-start">
            ...
            <div className="flex-grow-1">
              <h5 className="fw-bold mb-1">{selectedRoom.name}</h5>
          ...
          <div className="mb-4 text-center p-3 border rounded bg-light">
            <i className="bi bi-bed me-2" />
            <span className="text-muted">객실을 선택해주세요</span>
          </div>
        )}
        ...
        {rooms.length > 1 && showRoomSelect && (
          <div className="mb-4">
            <h6 className="fw-bold mb-2">객실 선택</h6>
            <Form.Select
              onChange={(e) => handleRoomChange(Number(e.target.value))}
              value={selectedRoom?.roomId || ""}
              className="w-100"
            >
              <option value="" disabled>객실을 선택하세요</option>
              {rooms.map(room => (
          ...
          <div className="p-3 border-top pt-4">
            <div className="d-flex justify-content-between mb-2">
              ...
              <span className="fw-bold">
                ₩{formatCurrency(roomPrice)} * {nights} 박
              </span>
            </div>
        ...
        {/* 예약 버튼 */}
        <Button
          className="w-100 py-3 mt-4 fw-bold"
          variant="dark"
          size="lg"
          onClick={onReserve}
