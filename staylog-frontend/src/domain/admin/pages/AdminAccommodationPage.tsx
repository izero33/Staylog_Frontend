...
function AdminAccommodationListPage() {
  ...
  }, [searchParams, searchParams.acType, searchParams.regionCode, searchParams.deletedYn]);
  ...
  return (
    <div className="container-fluid py-3">
      ...
      {/* ---- 모바일(카드) ---- */}
      <div className="d-lg-none d-grid gap-3 mt-4">
        {accommodations.map((item) => (
          <div key={item.accommodationId} className="card shadow-sm">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-start">
                <div>
                  ...
                  <div className="small text-muted">{item.regionName} · {item.typeName}</div>
                </div>
