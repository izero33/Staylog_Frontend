    ...
    <div className="container-fluid">
      ...
      <div className="d-flex flex-column mt-3">
        ...
        <div className="collapse d-md-flex" id="filterCollapse">
          {/* 상태/정렬 필터 그룹 */}
          <div className="gap-1 flex-wrap d-flex gap-2 align-items-center">
            <select
              name="status"
            ...
            <select
              ...
              onChange={(e) => {
                const [sortBy, sortOrder] = e.target.value.split("_") as [
                  "createdAt" | "viewsCount" | "rating" | "likes",
                  "ASC" | "DESC"
                ];
                setSearchParams((prev) => ({
                  ...prev,
              ...
              <div className="mt-3 d-flex align-items-center gap-2 flex-wrap">
                {searchParams.boardType === "BOARD_REVIEW" && (
                  <span className="badge bg-warning text-dark">
                    <i className="bi bi-star" /> {item.rating}
                  </span>
                )}
                ...
                <span className="badge bg-secondary">
                  <i className="bi bi-eye" /> {item.viewsCount}
                </span>
