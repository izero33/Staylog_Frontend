...
function Navbar() {
   ...
   return (
      <>
         <nav className="navbar fixed-top navbar-expand-lg border-bottom border-1 border-secondary-subtle shadow-sm" style={{ backgroundColor: '#ebebebff' }}>
            <div className="container-fluid w-75">
               ...
               <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <Link to="/" className="navbar-brand flex-fill fs-3 fw-normal" style={{ letterSpacing: '0.3rem' }}>STAYLOG</Link>
